...
2. **The "nothing to say" verdict is not a pass.** Two distinct three-valued
   systems: obligations are SATISFIED / VIOLATED / CANT-PROVE; review
   (`groundwork review`/`verify`) is STRUCTURALLY-CLEAR / BLOCK /
   NO-STRUCTURAL-SIGNAL. The third pole (CANT-PROVE, NO-STRUCTURAL-SIGNAL)
   means reachability could not answer — usually a blind spot on the path.
   Surface it as a disclosure; never report it as "looks fine."
