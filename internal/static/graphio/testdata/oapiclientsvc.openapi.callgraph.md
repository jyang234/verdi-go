...
flowchart LR
    ...
    %% 10 first-party nodes above tier 2 hidden as plumbing; pass --show-plumbing to include
    ...
    external_event_bus_GET__v1_events__eventId__status(["event-bus GET /v1/events/{eventId}/status"]):::external
    ...
    oapiclientsvc_publish -->|via openapi-client| external_event_bus_GET__v1_events__eventId__status
